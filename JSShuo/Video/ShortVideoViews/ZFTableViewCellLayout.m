...
- (instancetype)initWithData:(JSShortVideoModel *)data {
    self = [super init];
    if (self) {
        _data = data;
        ...
        min_y = 18;
        min_w = [data.author textSizeWithFont:[UIFont systemFontOfSize:15] limitWidth:min_view_w-2*margin-min_x].width;
        min_h = 15;
