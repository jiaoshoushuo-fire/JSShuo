...
@implementation JSWalletSwitchSegmentView
...
- (UIButton *)optionButtonRight {
    if (!_optionButtonRight) {
        _optionButtonRight = [UIButton buttonWithType:UIButtonTypeCustom];
...
- (UIButton *)optionButtonLeft {
    if (!_optionButtonLeft) {
        _optionButtonLeft = [UIButton buttonWithType:UIButtonTypeCustom];
