//
//  JSMyCollectArticleViewController.m
//  JSShuo
//
...
@interface JSMyCollectArticleCell : UITableViewCell
...
@end
@implementation JSMyCollectArticleCell
...
- (void)layoutSubviews{
    ...
    CGFloat height = [self.contentLabel sizeThatFits:CGSizeMake(kScreenWidth-40, MAXFLOAT)].height;
...
@interface JSMyCollectArticleViewController ()<UITableViewDelegate,UITableViewDataSource,JSMyCollectArticleCellDelegate>
...
@implementation JSMyCollectArticleViewController
...
- (UITableView *)tableView{
    if (!_tableView) {
        ...
        [_tableView registerClass:[JSMyCollectArticleCell class] forCellReuseIdentifier:@"JSMyCollectArticleCell"];
...
- (void)refreshDataWithHeaderRefresh:(BOOL)isHeaderRefresh{
    ...
    [JSNetworkManager requestCollectListWithType:1 pageNumber:self.currentPage complement:^(BOOL isSuccess, NSDictionary * _Nonnull contentDict) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    JSMyCollectArticleCell *cell = [tableView dequeueReusableCellWithIdentifier:@"JSMyCollectArticleCell" forIndexPath:indexPath];
